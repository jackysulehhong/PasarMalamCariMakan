...
public class pasar2_map extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch(menuItem.getItemId()){
                    case R.id.home:
                        Intent i =new Intent(pasar2_map.this,MainActivity.class);
                        startActivity(i);
                        finish();
                        break;
                    case R.id.recommend:
                        Intent c =new Intent(pasar2_map.this,recommended.class);
                        startActivity(c);
                        break;
                    case R.id.about:
                        Intent d =new Intent(pasar2_map.this,About.class);
                        startActivity(d);
                        break;
                    case R.id.contact:
                        Intent e =new Intent(pasar2_map.this,Contact.class);
                        startActivity(e);
                        break;
                }
        ...
        place2=new MarkerOptions().position(new LatLng(3.073684,101.672660)).title("Location2");
